...
export default function PopupModal({ children, isOpen = true, onClose, barrierDismissable = true, className, closeIcon = true }: iPopupModal) {
    ...
    return (
        <Transition
            ...
            leaveTo="opacity-0"
            className="fixed h-screen w-screen top-0 z-50 inset-0 bg-black bg-opacity-20 dark:bg-opacity-30 backdrop-blur-md flex flex-col items-center justify-center">
